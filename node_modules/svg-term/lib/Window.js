...
exports.Window = props => {
    ...
    return (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: width, height: height },
        react_1.default.createElement("rect", { key: "bg", width: width, height: height, rx: props.decorations ? 5 : 0, ry: props.decorations ? 5 : 0, fill: color_1.color(props.background) }),
